  ...
  return (
    <div className='checkout__content'>
      <div className='checkout__column'>
        <FormItem name='firstName' label='First Name' onChange={ handleChange } rules={ [
          {
            required: true,
        ...
        <FormItem name='lastName' label='Last Name' onChange={ handleChange } rules={ [
          {
            required: true,
      ...
      <div className='checkout__column'>
        <FormItem name='email' label='Email Address' onChange={ handleChange } rules={ [
          {
            type: 'email',
        ...
        <FormItem name='telephone' label='Telephone' onChange={ handleChange } rules={ [
          {
